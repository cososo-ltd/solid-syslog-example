...
The cost is not in flash — it is 1,536 bytes of RAM, because the record is built on the stack of
whichever task logs, and that seam had been sitting at the FreeRTOS minimum.
