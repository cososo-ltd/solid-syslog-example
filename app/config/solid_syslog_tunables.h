 ...
 * section 3.2 guarantees only that 480 will be accepted. This device's records
 * are a third of that, so 256 stays well inside every guarantee and anything
 * longer is truncated rather than dropped. Structured data is what will push
 * this back up. */
